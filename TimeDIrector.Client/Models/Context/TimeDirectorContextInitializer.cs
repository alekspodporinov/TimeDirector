...
{
	internal class TimeDirectorContextInitializer<T> : IDatabaseInitializer<T> where T : DbContext
	{

		bool _dbExists;
		DbModelBuilder _modelBuilder;

		public TimeDirectorContextInitializer(string dbPath, DbModelBuilder modelBuilder)
		{
